...
class ViewController: UIViewController {
    ...
    var contextItems = [
        ContextItem(title: "Role", subtitle: "Software Engineer", description: "I develop mobile apps."), ContextItem(title: "Location", subtitle: "San Francisco, CA", description: "I live in the Bay Area."), ContextItem(title: "College", subtitle: "Stanford University", description: "I studied Computer Science.")
    ]
